...
export default defineConfig({
    shortcuts: {
        ...
        'bottom-modal': 'bottom-0 left-1/2 rounded transform -translate-x-1/2 fixed ease w-11/12 md:w-2/3',
        'b-modal': 'top-[5%] position-fixed overflow-auto w-11/12 md:w-2/3',
